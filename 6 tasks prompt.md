...
6. Formato task: ID TASK-001, stato TODO/IN_PROGRESS/DONE/BLOCKED/DEFERRED, descrizione, priorità MUST/SHOULD/COULD, dipendenze, requisiti collegati, documenti di riferimento, criteri di completamento, verifica/test.
